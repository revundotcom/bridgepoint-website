                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full rounded-lg border ${fieldErrors.attached_portfolio ? "border-red-500" : "border-steel-200"} bg-steel-50 px-3 py-2.5 text-sm text-navy file:mr-4 file:rounded-lg file:border-0 file:bg-cyan/10 file:px-4 file:py-2 file:text-xs file:font-semibold file:text-cyan-700 hover:file:bg-cyan/20 cursor-pointer`}
                        />
                      ...
                      <div>
                        ...
                        <input
                          name="behance_url"
                          type="url"
                          className={`w-full rounded-lg border ${fieldErrors.behance_url ? "border-red-500" : "border-steel-200"} bg-steel-50 px-3 py-2.5 text-sm text-navy focus:outline-none focus:ring-2 focus:ring-cyan-500`}
